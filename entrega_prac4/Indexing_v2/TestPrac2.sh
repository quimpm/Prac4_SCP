...
time java -cp out/artifacts/Indexing_jar/Indexing.jar eps.scp.IndexingConc 8 test/example1.txt 10 Output/example1 5
time java -cp out/artifacts/Indexing_jar/Indexing.jar eps.scp.IndexingConc 8 test/example2.txt 10 Output/example2 5
time java -cp out/artifacts/Indexing_jar/Indexing.jar eps.scp.IndexingConc 8 test/example3.txt 10 Output/example3 5
...
time java -cp out/artifacts/Indexing_jar/Indexing.jar eps.scp.IndexingConc 8 test/pg2000.txt 10 Output/quijote/ 5
...
time java -cp out/artifacts/Indexing_jar/Indexing.jar eps.scp.Query 8 "En un lugar de la Mancha" Output/quijote/ test/pg2000.txt 10 5
